...
// ============================================
// Toast Viewport (contenedor de todos los toasts)
// ============================================
  ...
  ],
  {
    variants: {
      variant: {
        ...
        success:
          "border-success/50 bg-success/10 text-success dark:bg-success/20",
        destructive:
          "border-destructive/50 bg-destructive/10 text-destructive dark:bg-destructive/20",
        warning:
          "border-warning/50 bg-warning/10 text-warning dark:bg-warning/20",
...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Action
    ...
    className={cn(
      ...
      "group-[.destructive]:border-destructive/30 group-[.destructive]:hover:border-destructive/50",
...
// ============================================
// Toast Provider (de Radix, no confundir con nuestro ToastProvider)
// ============================================
