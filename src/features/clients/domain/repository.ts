...
export interface CreateClientAddressDTO {
  ...
  // ═══════════════════════════════════════════════════════════════════════════
  satEstadoCode: string; // c_Estado - OBLIGATORIO
  satMunicipioCode: string; // c_Municipio - OBLIGATORIO
  satLocalidadCode?: string; // c_Localidad - Opcional
  satColoniaCode?: string; // c_Colonia - Opcional
  postalCode: string; // Código postal - OBLIGATORIO
