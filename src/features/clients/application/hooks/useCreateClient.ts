...
export function useCreateClient() {
  ...
  return useMutation<CreateClientResult, Error, CreateClientWithAddressDTO>({
    ...
    onError: (error) => {
      ...
      if (error instanceof CreateClientCompensatedError) {
        ...
        toast({
          ...
          description:
            ...
            "La dirección fiscal no se registró. Puedes reintentar con los mismos datos.",
      ...
      if (error instanceof CreateClientAddressFailedError) {
        ...
        toast({
          ...
          description: `El cliente ${error.clientCode} se guardó, pero no se pudo registrar la dirección. Completa el domicilio en el detalle del cliente.`,
        ...
        // Evita re-POST del mismo alta: el cliente ya existe sin compensación.
